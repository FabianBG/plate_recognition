...
def export_h5_to_pb(path_to_h5, export_path, custom_objects):
    ...
    signature = predict_signature_def(inputs={"images": keras_model.input[0]},
                                      outputs={"scores": keras_model.output[1]})
